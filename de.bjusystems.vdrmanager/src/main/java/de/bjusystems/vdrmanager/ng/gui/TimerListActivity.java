...
import de.bjusystems.vdrmanager.ng.utils.svdrp.TimerClient;
...
OnItemClickListener {
   ...
   *
   * @see
   * de.bjusystems.vdrmanager.ng.gui.BaseEventListActivity#onCreate(android.os
   * .Bundle)
   */
  @Override
   ...
   *
   * @see
   * de.bjusystems.vdrmanager.ng.gui.BaseTimerEditActivity#getTimer(de.bjusystems
   ...
   *
   * @see
   * de.bjusystems.vdrmanager.ng.gui.BaseEventListActivity#prepareTimer(de.bjusystems
   * .vdrmanager.data.EventListItem)
   */
//  @Override
