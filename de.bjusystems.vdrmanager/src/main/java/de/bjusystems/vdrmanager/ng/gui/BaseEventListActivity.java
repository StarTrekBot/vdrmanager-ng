...
import de.bjusystems.vdrmanager.ng.gui.SimpleGestureFilter.SimpleGestureListener;
...
public abstract class BaseEventListActivity<T extends Event> extends
	 ...
	 *
	 * @see
	 * de.bjusystems.vdrmanager.ng.gui.BaseActivity#onCreateOptionsMenu(android
	 * .view.Menu)
	 */
	@Override
	 ...
	 *
	 * @see
	 * de.bjusystems.vdrmanager.ng.gui.BaseActivity#onOptionsItemSelected(android
	 * .view.MenuItem)
	 */
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		if (id == R.id.epg_list_sort_menu) {
			if (sortByDialog == null) {
				sortByDialog = new AlertDialog.Builder(this)
						.setTitle(R.string.sort)
						.setIcon(android.R.drawable.ic_menu_sort_alphabetically)
						.setSingleChoiceItems(getAvailableSortByEntries(), sortBy,
									...
									public void onClick(DialogInterface dialog, int which) {
										...
										new VoidAsyncTask() {
											...
											protected Void doInBackground(Void... params) {
												Preferences.set(BaseEventListActivity.this,
														getViewID() + "_" + P.EPG_LAST_SORT, sortBy);
												return null;
											}
										}.execute();
