...
import de.bjusystems.vdrmanager.ng.VdrSharedPreferencesImpl;
import de.bjusystems.vdrmanager.ng.ZonePicker;
import de.bjusystems.vdrmanager.ng.app.Intents;
import de.bjusystems.vdrmanager.ng.data.FetchEditTextPreference;
...
public class VdrPreferencesActivity extends BasePreferencesActivity implements
    ...
    // }
    // Zeit von 5 *1000 auf 7 *1000 geändert 30.07.2025
    private void ping(String ip, int port) throws Exception {
        Socket socket = new Socket();
        socket.connect(new InetSocketAddress(ip, port), 7 * 1000);
