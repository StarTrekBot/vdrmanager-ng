...
import de.bjusystems.vdrmanager.ng.tasks.DeleteRecordingTask;
import de.bjusystems.vdrmanager.ng.utils.date.DateFormatter;
import de.bjusystems.vdrmanager.ng.utils.svdrp.RecordingClient;
...
import de.bjusystems.vdrmanager.ng.utils.svdrp.SvdrpStartListener;
...
//	}
	...
	public boolean onContextItemSelected(final MenuItem item) {
		...
		if (id == R.id.recording_item_menu_delete) {
			...
			drt.start();
		} else if (id == R.id.recording_item_menu_stream) {
